  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-smooth focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        hero: "bg-gradient-hero text-white border-0 shadow-glow hover:shadow-primary hover:scale-105 transition-spring font-semibold",
        ...
        sky: "bg-gradient-sky text-accent-foreground hover:opacity-90 shadow-soft",
        growth: "bg-gradient-growth text-white hover:opacity-90 shadow-soft",
        voice: "bg-accent-bright text-white hover:bg-accent-bright/90 shadow-glow rounded-full animate-pulse",
      },
      size: {
